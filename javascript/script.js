...
function updateTimer() {
  const targetDate = new Date("january 10, 2025 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543884142756'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543884142756'; // Número para el primer botón
  const recipientNumber2 = '543884044435'; // Número para el segundo botón
  const recipientNumber3 = '543884632467'; // Número para el tercer botón
